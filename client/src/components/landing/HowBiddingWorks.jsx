    ...
    <section className="bg-steel-900 text-slate-300 font-body py-20 sm:py-28 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-8">
          ...
          <div className="hidden lg:block absolute top-[43px] left-[12%] right-[12%] border-t-2 border-dashed border-steel-600/80 z-0 pointer-events-none" />
            ...
            {steps.map((s, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col items-center text-center group">
                  ...
                  <div className="w-20 h-20 rounded-full bg-steel-800 border border-steel-700/80 flex items-center justify-center relative shadow-2xl group-hover:border-tata-gold group-hover:shadow-tata-gold/10 transition-all duration-300 mb-6 flex-shrink-0">
                    <StepIcon className="w-7 h-7 text-tata-gold group-hover:scale-105 transition-transform" />
                    
                    {/* Step Number Bubble Badge */}
                    <span className="absolute -top-1.5 -right-1.5 bg-tata-blue text-white w-7 h-7 rounded-full text-xs font-bold flex items-center justify-center border-2 border-steel-800 shadow-md">
                      {s.num}
                    </span>
                  </div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-400 leading-relaxed max-w-[220px] font-normal">
                    {s.desc}
                  </p>
                </div>
              );
