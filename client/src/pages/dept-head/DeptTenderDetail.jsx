    ...
    <div className="space-y-6 font-body">
      ...
      <div className="flex items-center space-x-2 border-b border-steel-700/60 pb-5">
        ...
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-white mt-0.5">Tender Specifications Details</h1>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-steel-800 border border-steel-700/60 rounded-2xl p-6 shadow-xl space-y-5">
            ...
            <div className="flex items-start justify-between border-b border-steel-700 pb-3">
              <div>
                <h2 className="text-lg sm:text-xl font-bold text-white leading-snug">{mockTender.title}</h2>
            ...
            <div className="grid grid-cols-3 gap-4 p-4 bg-steel-900/40 border border-steel-700/60 rounded-xl text-center text-xs">
              <div>
                <span className="text-[9px] uppercase font-mono tracking-widest text-slate-500 block leading-none">Target Budget</span>
                <span className="text-sm font-semibold text-tata-gold block mt-2">{mockTender.budget}</span>
              </div>
              <div>
                <span className="text-[9px] uppercase font-mono tracking-widest text-slate-500 block leading-none">Closing Due</span>
                <span className="text-sm font-semibold text-slate-300 block mt-2">{mockTender.deadline}</span>
              </div>
              <div>
                <span className="text-[9px] uppercase font-mono tracking-widest text-slate-500 block leading-none">Bids Lodged</span>
            ...
            <div className="space-y-2">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-300">Material scope</h3>
