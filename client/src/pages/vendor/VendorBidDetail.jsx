    ...
    <div className="space-y-6 font-body">
      ...
      <div className="flex items-center space-x-2 border-b border-steel-700/60 pb-5">
        ...
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-white mt-0.5">Bid Specifications: {id}</h1>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-steel-800 border border-steel-700/60 rounded-2xl p-6 shadow-xl space-y-5">
            <div>
              ...
              <h2 className="text-base sm:text-lg font-bold text-white mt-1.5 leading-snug">{mockBidDetails.title}</h2>
            ...
            <div className="grid grid-cols-2 gap-4 p-4 bg-steel-900/40 border border-steel-700/60 rounded-xl">
              <div>
                ...
                <span className="text-base font-semibold text-white block mt-2">{mockBidDetails.submittedPrice}</span>
              </div>
              <div>
                <span className="text-[9px] uppercase font-mono tracking-widest text-slate-500 block leading-none">Lead Delivery Time</span>
                <span className="text-base font-semibold text-white block mt-2">{mockBidDetails.deliveryDays}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-steel-800 border border-steel-700/60 rounded-2xl p-6 shadow-xl space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-3 bg-steel-900 border border-steel-700/60 rounded-xl">
                <span className="text-[9px] uppercase font-mono tracking-widest text-slate-500 block leading-none">Technical Score</span>
                <span className="text-base font-bold text-white block mt-1.5">{mockBidDetails.techScore}</span>
              </div>
              <div className="p-3 bg-steel-900 border border-steel-700/60 rounded-xl sm:col-span-2">
                <span className="text-[9px] uppercase font-mono tracking-widest text-slate-500 block leading-none">Compliance Comments</span>
                <p className="text-xs text-slate-300 leading-normal mt-1.5">{mockBidDetails.evalNotes}</p>
              </div>
            </div>
          </div>
            ...
            {getTimelineSteps().map((step, idx) => (
              <div key={idx} className="relative">
                ...
                <div className="space-y-1">
                  <h4 className="text-sm font-bold text-white leading-none">{step.label}</h4>
